...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        /**
         * =====================================================
         * TOTAL STOK & MIN PRICE
         * =====================================================
         */
        $totalStock = array_sum(
            array_column($request->ticket_types, 'stock')
        );

        $minPrice = min(
            array_column($request->ticket_types, 'price')
        );
        ...
        if ($request->hasFile('organiser_photo')) {
            ...
            $organiserPhotoName =
                ...
                time() .
                '.' .
                $orgFile->getClientOriginalExtension();
    ...
    public function update(Request $request, $id)
    {
        ...
        $isCriticalChanged =
            (
                ...
                json_encode($event->ticket_types) !== json_encode($request->tickets)
            );
