...
<div class="flex w-full min-h-screen bg-[#0f0f0f] relative">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <nav class="sticky top-0 z-50 glass border-b border-white/[0.04] px-6 lg:px-10 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center gap-2.5 mr-8">
                <div class="w-9 h-9 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center font-black text-white text-sm shadow-lg shadow-blue-500/20">T</div>
                <span class="font-black text-lg tracking-tight">Ticketify</span>
            </div>

            <div class="flex items-center gap-3 ml-auto">
                <a href="{{ route('login') }}" class="px-4 py-2 text-sm font-bold text-gray-400 hover:text-white transition-colors duration-300">Sign In</a>
                <a href="{{ route('register') }}" class="px-6 py-2.5 text-xs font-black bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl tracking-widest uppercase transition-all duration-300 shadow-lg shadow-blue-500/20 active:scale-[0.97]">
                    Daftar
                </a>
            </div>
        </nav>
        ...
        {{-- Grid Event --}}
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 px-8 pb-8 mt-6">
        ...
        {{-- About Us --}}
        <div class="px-8 pb-12 mt-auto border-t border-white/[0.04] pt-12">
            @include('layouts.about-us')
        </div>
    </div>

    {{-- SIDEBAR KANAN (Upcoming) --}}
    <aside class="w-80 hidden xl:flex flex-col sticky top-0 h-screen p-8 space-y-8 border-l border-white/[0.04]">
