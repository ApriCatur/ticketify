...
<body class="bg-[#09090b] text-white p-6 md:p-10" x-data="{ tab: 'ticket' }">
    ...
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center gap-4 mb-8">
            <a href="/" class="bg-[#18181b] hover:bg-white hover:text-black transition-all px-4 py-2 rounded-lg text-xs font-bold border border-white/5">
                <i class="fa-solid fa-arrow-left mr-2"></i> Back
            </a>
            <h1 class="text-2xl font-black tracking-tight">Event Seminar KMIPN VII</h1>
        </div>
