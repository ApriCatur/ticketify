            ...
            <!-- ini bagian sidebar -->
             <div class="space-y-6">
                <div>
                    ...
                    <nav class="space-y-1">
                        <a href="{{ route('event.index') }}"class="flex items-center gap-3 p-3 bg-blue-500 rounded-xl font-bold text-sm transition text-white">
                            <i class="fa-solid fa-home"></i> Event
                        </a>
                        <a href="{{ route('about') }}" class="flex items-center gap-3 p-3 hover:bg-white/5 rounded-xl text-sm text-gray-400 hover:text-white transition">
...
>>>>>>> f89a5822cc669b44cf2aedd05ecd6567fa0889bb
