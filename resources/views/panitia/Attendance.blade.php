        ...
        <div class="space-y-6">
            <div>
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('panitia.myevent') }}" class="flex items-center gap-3 p-3 hover:bg-white/5 rounded-xl font-bold text-sm transition text-white shadow-lg shadow-blue-500/20">
                        <i class="fa-solid fa-layer-group"></i> My Event
                    </a>
                    <a href="{{ route('panitia.attendance') }}" class="flex items-center gap-3 p-3 bg-blue-500 rounded-xl font-bold text-sm transition text-white shadow-lg shadow-blue-500/20">
