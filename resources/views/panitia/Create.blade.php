        ...
        <div class="space-y-6">
            <div>
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('panitia.create') }}" class="flex items-center gap-3 p-3 bg-blue-500 rounded-xl font-bold text-sm transition text-white shadow-lg shadow-blue-500/20">
                    ...
                    <a href="{{ route('panitia.attendance') }}" class="flex items-center gap-3 p-3 hover:bg-white/5 rounded-xl text-[13px] text-gray-400 hover:text-white transition text-xs">
