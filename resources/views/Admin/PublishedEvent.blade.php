...
<div class="px-8 py-8 -mt-4 relative z-30">
    <div class="bg-[#1e1e1e] border border-white/10 rounded-2xl p-4 shadow-2xl flex flex-wrap lg:flex-nowrap items-end gap-4">

        <div class="flex-[2] min-w-[200px]">
            <label class="text-[9px] font-black text-gray-500 uppercase tracking-widest mb-2 block ml-1">
                Search Event
            </label>
            <div class="flex items-center gap-3 bg-white/5 rounded-xl px-4 py-3 border border-transparent focus-within:border-blue-500 transition">
                ...
                <input type="text" placeholder="Search event..." class="bg-transparent w-full outline-none text-sm text-gray-200">
            </div>
        </div>
        ...
        <div class="flex-1 min-w-[150px]">
            ...
            <select class="w-full bg-white/5 border border-transparent rounded-xl py-3 px-4 text-xs font-bold text-gray-300 focus:border-blue-500 outline-none transition">
        ...
        <div class="flex-1 min-w-[150px]">
            ...
            <input type="date" class="w-full bg-white/5 border border-transparent rounded-xl py-3 px-4 text-xs font-bold text-gray-300 focus:border-blue-500 outline-none transition [color-scheme:dark]">
        </div>

        <button class="px-8 py-3.5 bg-white text-black rounded-xl font-bold hover:bg-blue-500 hover:text-white transition-all active:scale-95 shadow-lg">
            Search
        </button>
    </div>
</div>
