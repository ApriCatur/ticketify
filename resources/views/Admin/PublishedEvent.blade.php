...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-bold text-slate-900">Published Event</h2>
                <p class="text-slate-500">Manage all active published events</p>
            </div>
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-md transition group">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex gap-2">
                            <button class="px-4 py-2 border border-slate-200 rounded-xl text-sm hover:bg-slate-50 transition">
                                Detail
                            </button>
