@php $hasRightSidebar = true; $navTitle = 'Pending Events'; $navSubtitle = 'Review event yang diajukan panitia'; @endphp
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-8 pb-8 mt-6">
    @forelse($pendingEvents as $event)
        ...
        >
            ...
            <button type="button"
                class="px-4 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 rounded-lg text-xs font-bold transition"
...
<div id="approveModal" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50 p-4">
    <div class="bg-[#1e1e1e] rounded-2xl p-6 w-full max-w-md border border-white/10 text-center">
        ...
        <h3 class="text-xl font-black mb-2">Setujui Event?</h3>
        <p id="approveEventName" class="text-gray-400 text-sm mb-6">Event akan dipublikasikan ke halaman utama.</p>
...
<div id="rejectModal" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50 p-4">
    <div class="bg-[#1e1e1e] rounded-2xl p-6 w-full max-w-lg border border-white/10">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                <h2 class="text-base font-bold">Tolak Event</h2>
                <p class="text-xs text-gray-400">Berikan alasan mengapa event ini ditolak</p>
            </div>
        </div>
