...
<div class="p-8">
    ...
    @if(session('error'))
        <div class="p-4 bg-red-500/10 border border-red-500/20 text-red-400 rounded-2xl text-sm flex items-center gap-3">
    ...
    <div class="bg-[#1e1e1e] rounded-2xl p-6 w-full max-w-md border border-white/10">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400">Event akan dipindahkan ke status <span class="text-red-400 font-bold">Rejected</span></p>
            </div>
        </div>
